...
import { Menu, LogOut, User as UserIcon, Sparkles, Home, Calendar as CalendarIcon, Users, CheckSquare, Target, Image as ImageIcon, Rss } from 'lucide-react';
    ...
    <div className="min-h-screen bg-beige flex flex-col">
      <div className="flex-grow">
        ...
        {(bannerTitle || bannerDetails) && (
          <div className="fixed top-0 w-full bg-background/95 text-foreground backdrop-blur-md border-b border-border z-50">
        ...
        {/* Navigation */}
        <nav className={`fixed ${hasBanner ? 'top-20' : 'top-12'} w-full bg-gradient-primary text-black backdrop-blur-md border-b border-border/20 shadow-sm shadow-black/6 z-40 animate-in fade-in slide-in-from-top-4 duration-500`}>
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center py-4">
              ...
              <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center transition-transform hover:scale-110">
                      <img src="https://www.rgpv.ac.in/Images/RGPVLOGO.JPG" alt="FestHub Logo" className="w-full h-full object-cover rounded-full" />
                  </div>
            ...
            {/* Mobile Navigation */}
            {mobileMenuOpen && (
              <div className="md:hidden pb-4 animate-in slide-in-from-top-4 duration-300 bg-gradient-primary text-black">
        ...
        {/* Main Content */}
        <main className={`${hasBanner ? 'pt-32' : 'pt-24'}`}>
          {children}
        </main>

        {/* Scroll Progress Indicator */}
        <div className={`fixed ${hasBanner ? 'top-20' : 'top-12'} left-0 w-full h-1 bg-muted z-30`}>
